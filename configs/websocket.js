...
module.exports = {
    websocket_max_connect: process.env.WEBSOCKET_MAX_CONNECT || 0,//服务器最多发websocket连接数量 0为不限制
    ...
    user_max_connect: process.env.WEBSOCKET_USER_MAX_CONNECT || 1,//一个用户最多发起几个websocket连接数量 0为不限制
